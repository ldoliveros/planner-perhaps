...
export default function ClientLoginPage() {
  ...
  return (
    <AuthSplitLayout>
      ...
      {mode === "password" && <PasswordForm onMagicLink={() => setMode("magic")} onForgot={() => setMode("forgot")} />}
...
/** Acceso principal: email + contraseña (el mismo `signIn` que el equipo; el rol decide el destino). */
function PasswordForm({ onMagicLink, onForgot }: { onMagicLink: () => void; onForgot: () => void }) {
  ...
  return (
    <>
      ...
      <p className="mt-3 text-sm text-muted-foreground">Ingresá con tu email y contraseña.</p>
...
/** Alternativa: link de acceso por email (mismo usuario; no crea cuentas nuevas). */
