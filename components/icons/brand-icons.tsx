...
export function TiktokIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M16.6 5.82c-1.001-.983-1.581-2.328-1.581-3.82h-3.44v13.61c0 1.735-1.412 3.147-3.147 3.147a3.147 3.147 0 0 1-3.147-3.147 3.147 3.147 0 0 1 3.147-3.147c.322 0 .632.05.925.14V9.14a6.61 6.61 0 0 0-.925-.065A6.6 6.6 0 0 0 1.835 15.61 6.6 6.6 0 0 0 8.432 22.2a6.6 6.6 0 0 0 6.597-6.59V9.007a9.55 9.55 0 0 0 5.58 1.788V7.348a6.06 6.06 0 0 1-3.61-1.528h-.399z" />
    </svg>
  );
}

const PLATFORM_ICONS: Record<string, React.ComponentType<SVGProps<SVGSVGElement>>> = {
...
/**
 * Ícono de marca para un canal. Los canales agregados a futuro que no tengan
 * un SVG propio caen a un ícono genérico.
 */
